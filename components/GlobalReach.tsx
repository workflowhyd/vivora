...
export function GlobalReach() {
  return (
    <section id="global-reach" className="bg-forest py-24 md:py-36 overflow-hidden">
      <div className="mx-auto max-w-[1440px] px-6 md:px-10">
        <Reveal className="text-center max-w-xl mx-auto mb-16 md:mb-20">
          <span className="label-caps text-[12px] text-yellow">Worldwide</span>
        ...
        <div className="relative w-full aspect-[16/9] md:aspect-[21/9] rounded-[2px] border border-ivory/10 bg-forest-light/40 overflow-hidden">
          <svg
            className="absolute inset-0 h-full w-full opacity-30"
            aria-hidden
          >
            <pattern id="dotgrid" width="22" height="22" patternUnits="userSpaceOnUse">
              <circle cx="1.5" cy="1.5" r="1.1" fill="#fbf6ea" />
            </pattern>
          ...
          {globalDestinations.map((dest, i) => (
            ...
            >
              ...
              <span className="absolute left-1/2 top-full mt-2 -translate-x-1/2 whitespace-nowrap label-caps text-[9px] md:text-[10px] text-ivory/70">
                {dest.name}
              </span>
            </motion.div>
          ))}
